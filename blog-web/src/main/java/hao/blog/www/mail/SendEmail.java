...
public class SendEmail {
    ...
    public static void sendEmailMessage(String email,String validateCode) {
       try {
           ...
           String from = "qq1078470796@163.com";    //发邮件的出发地（发件人的信箱）
           ...
           MyAuthenticator myauth = new MyAuthenticator(from, "haoxinyu123");
...
//    session.setDebug(true);
           ...
           // Set the subject
           message.setSubject("BLOG激活邮件通知");

           // Set the content
           message.setContent( "<a>感谢您使用BLOG论坛系统。</a>","text/html;charset=gb2312");
