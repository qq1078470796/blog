                    ...
                    <ul class="nav navbar-nav cl-effect-18" id="cl-effect-18">
                        ...
                        <li role="presentation" class="dropdown">
                            <c:if test="${empty user}">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a name="tj_login" class="lb" href="login?error=login" style="color: black">[请登录]</a>
                                    </li>
                                    <li>
                            ...
                            <c:if test="${not empty user}">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a name="tj_loginp" href="javascript:void(0);" class="lb" onclick="personal('${user.id}');" style="color: black">
                                            <font color="#b22222">${user.nickName}的个人空间</font>
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div class="content-text">
                                <div class="admin-text">
                                    ...
                                    <div class="admin-text-left">
                                        <a href="#"><img src="${cont.imgUrl}" alt=""/></a>
                                    </div>
                                    <div class="admin-text-right">
                                        <p>感谢浏览此文</p>
                                        <span>转发请携带作者:<a href="#">${cont.nickName}</a></span>
                                    </div>
                                    <div class="single-share" style="border-width: medium">
                                ...
                                <h2 style="align-content: center">${cont.title}</h2>
                                <br/>
                                ${cont.content}
